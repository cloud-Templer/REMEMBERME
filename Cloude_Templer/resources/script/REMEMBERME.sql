...
CREATE TABLE PAINT_PHOTO (
	...
	FILEPATH	NVARCHAR2(100)	NULL,
	FILELEVEL	NVARCHAR2(100)	NULL
);
...
ALTER TABLE FREE_BOARD_REPLY ADD CONSTRAINT TO_FREE_BOARD_REPLY_1 FOREIGN KEY (
	FREE_NO
)
